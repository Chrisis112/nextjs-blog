  ...
  return (
    <>
      ...
      <section className="text-center my-8" id="contact">
        ...
        <div className="mt-2">
          <a href="https://maps.app.goo.gl/GQ5jHkTBXVvaJ8Hw5" className="text-1xl text-gray-500"> Suur-Karja tn 11, Vanalinn, Tallinn </a>
                  <div className="mt-2">
                    <a href="https://maps.app.goo.gl/GQ5jHkTBXVvaJ8Hw5" className="text-1xl text-gray-500"> Stroomi keskus, Põhja-Tallinn, Tallinn</a>
        </div>
        </div>
